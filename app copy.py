...
def plot_cum_returns(data, title):    
	...
	daily_cum_returns = daily_cum_returns.cumprod()*investment_amount
...
try:
	...
	#fig_cum_returns = plot_cum_returns(stocks_df, 'Cumulative Returns of Individual Stocks with your investment amount')
	...
	# The number of stock you should buy
	ww = (weights_df.iloc[:,0]).to_dict()
	da = DiscreteAllocation(ww, latest_prices = get_latest_prices(stocks_df), total_portfolio_value=investment_amount)
	...
	fig_cum_returns_optimized = plot_cum_returns(stocks_df['Optimized Portfolio'], 'Cumulative Returns of Optimized Portfolio with your investment amount')
